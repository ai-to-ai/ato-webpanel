export default function Join(): JSX.Element {
    return (
        <>
            <div className="flex w-[90%] sm:w-full flex-col items-center bg-gradient-to-b bg-white to-[#080818] sm:px-6 rounded-t-md pt-24 sm:pt-64">
                <div className="align-center flex w-full sm:max-w-[1100px] flex-col items-center justify-center text-center">
                    <div className="align-center flex h-full w-full flex-col items-center justify-center rounded-t-md bg-gradient-to-br from-[#12121A] to-[#09090C] border border-[#19191F] border-b-0">
                        <div className="flex h-full w-full flex-col bg-[url('/images/bg_landing.webp')] bg-right-top bg-no-repeat sm:bg-[length:256px]">
                            <div className="align-center flex h-full w-full flex-col items-center justify-center px-20 py-12 sm:py-36">
                                ...
                                <h3 className="text-md mt-1 w-full text-center font-light text-white sm:mt-5 sm:w-2/3">
