export default function Footer(): JSX.Element {
    return (
        <>
            <div className="align-center flex w-full flex-col items-center border-t border-[#a5907f] bg-white py-16 px-12 sm:flex-row sm:justify-between">
                    ...
                    <div className="align-center flex w-full flex-row items-center justify-center gap-4 sm:items-start sm:justify-end">
                        <a href="#">
                            <svg
                                ...
                                strokeWidth={0}
                                viewBox="0 0 640 512"
                                className="text-[32px] text-[#343445] transition-all ease-in-out hover:opacity-80 hover:ease-in focus:opacity-60 focus:ease-out"
                                height="1em"
                                width="1em"
